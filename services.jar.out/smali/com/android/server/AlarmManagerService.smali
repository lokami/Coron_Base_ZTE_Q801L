...
.field private static final AUTOSTART_RTC_FLAG:B = 0x73t

.field private static final COMMON_RTC_FLAG:B = 0x61t
...
.field private static final RTC_POWEROFF_WAKEUP_MASK:I = 0x40

.field private static final RTC_POWERON_MASK:I = 0x10

.field private static final RTC_WAKEUP_MASK:I = 0x1

.field private static final SAVE_RTC_TYPE_FILENAME:Ljava/lang/String; = "/data/data/com.android.server/alarmMgr/rtcType.txt"
...
.field private final mRtcPoweroffAlarms:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v3, p0, Lcom/android/server/AlarmManagerService;->map:Ljava/util/Map;
    ...
    iput-object v3, p0, Lcom/android/server/AlarmManagerService;->mRtcPoweroffAlarms:Ljava/util/ArrayList;
    ...
    .line 142
    iput v5, p0, Lcom/android/server/AlarmManagerService;->mLastRtcType:I
    ...
    .line 238
    :goto_0
    invoke-direct {p0}, Lcom/android/server/AlarmManagerService;->readRtcType()I

    move-result v3

    iput v3, p0, Lcom/android/server/AlarmManagerService;->mLastRtcType:I
...
.method static synthetic access$2000(Lcom/android/server/AlarmManagerService;)Ljava/util/ArrayList;
    ...
    .prologue
    .line 77
    iget-object v0, p0, Lcom/android/server/AlarmManagerService;->mRtcPoweroffAlarms:Ljava/util/ArrayList;
...
.method private adjustAlarmRtcType(Lcom/android/server/AlarmManagerService$Alarm;)V
    .locals 3
    .parameter "alarm"
    ...
    iput v0, p1, Lcom/android/server/AlarmManagerService$Alarm;->rtcType:I
...
.method private native clear_cjg(II)I
.end method
...
.method private isForceSync(Ljava/lang/String;)Z
    .locals 4
    .parameter "pkgName"

    .prologue
    .line 393
    const-string v2, "persist.use_force_sync"
    ...
    .line 396
    iget-object v2, p0, Lcom/android/server/AlarmManagerService;->map:Ljava/util/Map;
...
.method private readRtcType()I
    ...
    const-string v5, "/data/data/com.android.server/alarmMgr/rtcType.txt"
    ...
    const-string v6, "[act02]doGetRtcType(), FileNotFoundException"
    ...
    const-string v6, "[act02]doGetRtcType(), IOException"
...
.method private saveRtcType(Lcom/android/server/AlarmManagerService$Alarm;)V
    .locals 9
    .parameter "alarm"
    ...
    const-string v6, "/data/data/com.android.server/alarmMgr/rtcType.txt"
    ...
    const-string v8, "[act02]saveRtcType(), current rtc alarm rtcType: "

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    iget v8, p1, Lcom/android/server/AlarmManagerService$Alarm;->rtcType:I
    ...
    iget v6, p1, Lcom/android/server/AlarmManagerService$Alarm;->rtcType:I
    ...
    const-string v7, "[act02]saveRtcType(), FileNotFoundException"
    ...
    const-string v7, "[act02]saveRtcType(), IOException"
...
.method private setLocked(Lcom/android/server/AlarmManagerService$Alarm;)V
    ...
    :goto_0
    invoke-direct {p0, p1}, Lcom/android/server/AlarmManagerService;->saveRtcType(Lcom/android/server/AlarmManagerService$Alarm;)V
...
.method private setRtcPowerOnAlarm()V
    .locals 5
    ...
    .line 1133
    .local v1, tempAlarm:Lcom/android/server/AlarmManagerService$Alarm;
    ...
    const-string v4, "setRtcPowerOnAlarm set tempAlarm "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    invoke-virtual {v1}, Lcom/android/server/AlarmManagerService$Alarm;->toString()Ljava/lang/String;
    ...
    .line 1141
    .end local v1           #tempAlarm:Lcom/android/server/AlarmManagerService$Alarm;
    :goto_0
    return-void
    ...
    const-string v3, "setRtcPowerOnAlarm clear"
    ...
    invoke-direct {p0, v2, v4}, Lcom/android/server/AlarmManagerService;->clear_cjg(II)I
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v3, v0, Lcom/android/server/AlarmManagerService;->mRtcPoweroffAlarms:Ljava/util/ArrayList;
    ...
    iget-object v4, v0, Lcom/android/server/AlarmManagerService;->mRtcPoweroffAlarms:Ljava/util/ArrayList;

    const-string v5, "  "

    const-string v6, "RTC_POWEROFF_WEKEUP"
    ...
    iget-object v3, v0, Lcom/android/server/AlarmManagerService;->mRtcPowerOnAlarms:Ljava/util/ArrayList;
    ...
    .line 910
    const-string v3, "  RTC power on now="
    ...
    iget-object v4, v0, Lcom/android/server/AlarmManagerService;->mRtcPowerOnAlarms:Ljava/util/ArrayList;

    const-string v5, "  "

    const-string v6, "RTC_POWERON"
...
.method public getPowerOnType()I
    ...
    .prologue
    .line 1029
    iget v0, p0, Lcom/android/server/AlarmManagerService;->mLastRtcType:I
...
.method public removeEx(Landroid/app/PendingIntent;I)V
    ...
    const-string v5, "removeEx return for type "
    ...
    invoke-direct {p0, v3, p2}, Lcom/android/server/AlarmManagerService;->clear_cjg(II)I

    .line 1157
    const-string v3, "AlarmManager"

    const-string v5, "removeEx has no alarm, clear and return"
    ...
    .line 1161
    .restart local v1       #alarmList:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/server/AlarmManagerService$Alarm;>;"
    :cond_2
    :try_start_1
    ...
    iget v5, v0, Lcom/android/server/AlarmManagerService$Alarm;->rtcType:I
    ...
    const-string v6, "removeEx remove alarm "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    invoke-virtual {v0}, Lcom/android/server/AlarmManagerService$Alarm;->toString()Ljava/lang/String;
    ...
    .end local v0           #alarm:Lcom/android/server/AlarmManagerService$Alarm;
    :cond_4
    invoke-direct {p0}, Lcom/android/server/AlarmManagerService;->setRtcPowerOnAlarm()V
...
.method public setRepeating(IJJLandroid/app/PendingIntent;)V
    ...
    invoke-direct {v0, v9}, Lcom/android/server/AlarmManagerService;->adjustAlarmRtcType(Lcom/android/server/AlarmManagerService$Alarm;)V
...
.method public setRepeatingForSync(IJJLandroid/app/PendingIntent;)V
    ...
    .line 455
    invoke-direct {p0, v0}, Lcom/android/server/AlarmManagerService;->adjustAlarmRtcType(Lcom/android/server/AlarmManagerService$Alarm;)V
