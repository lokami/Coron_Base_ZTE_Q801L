...
# instance fields
.field EMHandler:Landroid/os/Handler;
...
.field final mKeyTestResults:Ljava/lang/Runnable;
...
.field mQuitBootWakeLock:Landroid/os/PowerManager$WakeLock;
...
.method public constructor <init>()V
    ...
    .line 250
    iput-boolean v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->isKeyTestOn:Z
    ...
    iput-object v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mKeyTestResults:Ljava/lang/Runnable;
...
.method private interceptPowerKeyDown(Z)V
    ...
    .line 669
    iget-object v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mQuitBootWakeLock:Landroid/os/PowerManager$WakeLock;
...
# virtual methods
.method IsInEMode_KeyTestDelay()V
    .locals 4

    .prologue
    .line 874
    iget-object v0, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->EMHandler:Landroid/os/Handler;

    iget-object v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mKeyTestResults:Ljava/lang/Runnable;
...
.method public init(Landroid/content/Context;Landroid/view/IWindowManager;Landroid/view/WindowManagerPolicy$WindowManagerFuncs;)V
    ...
    iput-object v4, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->EMHandler:Landroid/os/Handler;
    ...
    const-string v5, "PhoneWindowManager.mQuitBootWakeLock"

    invoke-virtual {v4, v9, v5}, Landroid/os/PowerManager;->newWakeLock(ILjava/lang/String;)Landroid/os/PowerManager$WakeLock;

    move-result-object v4

    iput-object v4, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mQuitBootWakeLock:Landroid/os/PowerManager$WakeLock;
...
.method public interceptKeyBeforeDispatching(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/KeyEvent;I)J
    ...
    .line 1995
    .local v13, audioService:Landroid/media/IAudioService;
    if-eqz v13, :cond_0

    .line 1997
    :try_start_0
    invoke-interface {v13}, Landroid/media/IAudioService;->getRingtonePlayer()Landroid/media/IRingtonePlayer;
    ...
    .line 1999
    invoke-interface/range {v29 .. v29}, Landroid/media/IRingtonePlayer;->stopAsync()V
    :try_end_0
    ...
    .line 1984
    .end local v13           #audioService:Landroid/media/IAudioService;
    ...
    .line 2010
    .restart local v13       #audioService:Landroid/media/IAudioService;
    ...
    iget-boolean v3, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->isKeyTestOn:Z
...
.method public interceptKeyBeforeQueueing(Landroid/view/KeyEvent;IZ)I
    ...
    .line 3766
    const-string v17, "service.quickboot.state"
    ...
    const-string v19, "QuickBoot UP Press quickBootState="
    ...
    const-string v18, "QuickBoot UP Power Key Down"
    ...
    const-string v18, "QuickBoot UP Power Key Up"
    ...
    .end local v14           #quickBootState:I
    :cond_5
    const/4 v5, 0x0
    ...
    .restart local v14       #quickBootState:I
    :cond_a
    if-eqz v5, :cond_b
    ...
    invoke-interface/range {v17 .. v17}, Landroid/os/IHardwareService;->turnOffButtonLightOneShot()V
    :try_end_4
...
.method isInEmode()Z
    ...
    .line 1961
    const-string v2, "sys.emode.keystatus"
    ...
    const-string v3, "isInEmode return true."
    ...
    .line 1968
    :cond_0
    iget-boolean v1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->isKeyTestOn:Z

    if-eqz v1, :cond_1

    .line 1970
    invoke-virtual {p0}, Lcom/android/internal/policy/impl/PhoneWindowManager;->IsInEMode_KeyTestDelay()V
...
.method public rotationForOrientationLw(II)I
    ...
    invoke-virtual {v2}, Lcom/android/internal/policy/impl/WindowOrientationListener;->getProposedRotation()I
