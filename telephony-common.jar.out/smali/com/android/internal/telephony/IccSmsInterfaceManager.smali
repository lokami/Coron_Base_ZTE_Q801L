...
.field private static final EVENT_TDD_ONLY_MODE:I = 0xa
...
# instance fields
.field private SimSmsRecordSize:I
...
.method protected constructor <init>(Lcom/android/internal/telephony/PhoneBase;)V
    ...
    iput v0, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->SimSmsRecordSize:I
...
.method static synthetic access$002(Lcom/android/internal/telephony/IccSmsInterfaceManager;I)I
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 76
    iput p1, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->SimSmsRecordSize:I
...
.method static synthetic access$200(Lcom/android/internal/telephony/IccSmsInterfaceManager;Landroid/os/Message;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 76
    invoke-direct {p0, p1}, Lcom/android/internal/telephony/IccSmsInterfaceManager;->onTddOnlyMode(Landroid/os/Message;)V

    return-void
.end method

.method static synthetic access$300(Lcom/android/internal/telephony/IccSmsInterfaceManager;[Lcom/android/internal/telephony/gsm/SmsBroadcastConfigInfo;)Z
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$400(Lcom/android/internal/telephony/IccSmsInterfaceManager;[Lcom/android/internal/telephony/cdma/CdmaSmsBroadcastConfigInfo;)Z
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method private isTddOnlyMode()Z
    .locals 4
    ...
    invoke-virtual {v2, v3}, Landroid/telephony/MSimTelephonyManager;->isTddOnlyMode(I)Z

    move-result v0

    .line 572
    .local v0, isTddOnly:Z
    :goto_0
    if-eqz v0, :cond_0
    ...
    invoke-virtual {v2, v3}, Landroid/telephony/TelephonyManager;->isTddOnlyMode(Landroid/content/Context;)Z
...
.method private onTddOnlyMode(Landroid/os/Message;)V
    .locals 2
    .parameter "msg"
    ...
    .line 166
    :try_start_0
    const-string v1, "onTddOnlyMode() try to startActivity()"
    ...
    const-string v1, "android.intent.action.TDD_ONLY_MODE"
...
.method public copyMessageToIccEf(I[B[BI)Z
    ...
    const-string v4, "copyMessageToIccEf 2: status="
    ...
    .line 416
    const-string v3, "Copying message to UIcc"
    ...
    .line 424
    const-string v2, "mPhone.mCi.writeSmsToSim()"
    ...
    .line 430
    :try_start_3
    const-string v2, "mPhone.mCi.writeSmsToRuim()"
...
.method public copyMessageToIccEf(Ljava/lang/String;I[B[B)Z
    ...
    const-string v4, "copyMessageToIccEf 1: status="
...
.method public getAllMessagesFromIccEf()Ljava/util/List;
    ...
    .prologue
    .line 455
    const-string v3, "getAllMessagesFromEF (1)"
...
.method public getAllMessagesFromIccEf(Ljava/lang/String;)Ljava/util/List;
    ...
    .prologue
    .line 368
    const-string v0, "getAllMessagesFromEF (2)"

    invoke-virtual {p0, v0}, Lcom/android/internal/telephony/IccSmsInterfaceManager;->log(Ljava/lang/String;)V

    .line 407
    invoke-virtual {p0}, Lcom/android/internal/telephony/IccSmsInterfaceManager;->getAllMessagesFromIccEf()Ljava/util/List;
...
.method public getSimSmsCapability()[I
    ...
    .line 485
    const-string v1, "getSimSmsCapability"
    ...
    const-string v3, "Reading messages from SIM"
    ...
    iput-object v1, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->mSms:Ljava/util/List;
    ...
    .line 510
    iget v1, p0, Lcom/android/internal/telephony/IccSmsInterfaceManager;->SimSmsRecordSize:I
    ...
    const-string v2, "SimSmsCapability = "
...
.method public sendData(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;I[BLandroid/app/PendingIntent;Landroid/app/PendingIntent;)V
    ...
    .line 558
    :cond_2
    invoke-direct {p0}, Lcom/android/internal/telephony/IccSmsInterfaceManager;->isTddOnlyMode()Z
...
.method public sendMultipartTextExtra(Ljava/lang/String;Ljava/lang/String;Ljava/util/List;Ljava/util/List;Ljava/util/List;Landroid/os/Bundle;)V
    ...
    :cond_0
    sget-boolean v1, Landroid/util/Config;->ZTE_FEATURE_DISABLED_SMS_SENDING_FUNCTION:Z
    ...
    const-string v2, "sendMultipartTextExtra"
...
.method public sendRgData(Ljava/lang/String;Ljava/lang/String;[BLandroid/app/PendingIntent;Landroid/app/PendingIntent;)V
    ...
    .line 594
    :cond_0
    sget-boolean v0, Landroid/util/Config;->ZTE_FEATURE_DISABLED_SMS_SENDING_FUNCTION:Z
