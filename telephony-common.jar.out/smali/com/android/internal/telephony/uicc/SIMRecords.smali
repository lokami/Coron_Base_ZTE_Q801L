...
.method protected handleFileUpdate(I)V
    ...
    .line 1241
    :sswitch_6
    const-string v1, "SIM Refresh for EF_ADN"

    invoke-virtual {p0, v1}, Lcom/android/internal/telephony/uicc/SIMRecords;->log(Ljava/lang/String;)V

    .line 1242
    iput-boolean v2, p0, Lcom/android/internal/telephony/uicc/IccRecords;->refresh_init:Z

    .line 1243
    iget-boolean v1, p0, Lcom/android/internal/telephony/uicc/IccRecords;->refresh_updatefile:Z

    if-nez v1, :cond_0

    .line 1245
    iput-boolean v5, p0, Lcom/android/internal/telephony/uicc/IccRecords;->refresh_updatefile:Z
    ...
    .line 1247
    const-string v1, "==ACTION_SIM_REFRESH_UPDATE=="
    ...
    const-string v1, "android.intent.action.ACTION_SIM_REFRESH_UPDATE"
    ...
    :cond_0
    iput-boolean v2, p0, Lcom/android/internal/telephony/uicc/IccRecords;->refresh_updatefile:Z
...
.method protected onAllRecordsLoaded()V
    ...
    .line 1395
    const-string v2, "=ACTION_SIM_REFRESH_UPDATE="

    invoke-virtual {p0, v2}, Lcom/android/internal/telephony/uicc/SIMRecords;->log(Ljava/lang/String;)V

    .line 1396
    iget-boolean v2, p0, Lcom/android/internal/telephony/uicc/IccRecords;->refresh_init:Z

    if-eqz v2, :cond_0

    .line 1398
    iput-boolean v6, p0, Lcom/android/internal/telephony/uicc/IccRecords;->refresh_init:Z
    ...
    invoke-static {v0, v5, v2}, Landroid/app/ActivityManagerNative;->broadcastStickyIntent(Landroid/content/Intent;Ljava/lang/String;I)V
...
.method public setVoiceMessageWaiting(IILandroid/os/Message;)V
    ...
    invoke-virtual {p0, v5, v7, v8, p3}, Landroid/os/Handler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-virtual {p0, v3, v4, v5, p3}, Landroid/os/Handler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
