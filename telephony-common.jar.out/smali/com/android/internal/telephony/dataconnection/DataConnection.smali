...
.method private tearDownData(Ljava/lang/Object;)V
    ...
    const-string v7, "--cdmadct-tearDownData radio is on, call deactivateDataCall,mrilrat="

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget v7, p0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mRilRat:I

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v6

    const-string v7, ",--isUserDataEnabled="
    ...
    const-string v7, "--cdmadct-tearDownData radio is on, apntype="
    ...
    invoke-direct {v1, p1, v8, v8}, Landroid/os/AsyncResult;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Throwable;)V

    .line 511
    .local v1, ar:Landroid/os/AsyncResult;
    iget v6, p0, Lcom/android/internal/telephony/dataconnection/DataConnection;->mTag:I

    invoke-virtual {p0, v9, v6, v5, v1}, Lcom/android/internal/util/StateMachine;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
    ...
    .end local v0           #apnContext:Lcom/android/internal/telephony/dataconnection/ApnContext;
    .end local v4           #isUserDataEnabled:Z
    :cond_1
    move v4, v5
    ...
    .restart local v4       #isUserDataEnabled:Z
    :cond_2
    iget-object v6, v3, Lcom/android/internal/telephony/dataconnection/DataConnection$DisconnectParams;->mReason:Ljava/lang/String;
    ...
    invoke-virtual {p0, v9, v8, v5, p1}, Lcom/android/internal/util/StateMachine;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;

    move-result-object v5

    invoke-interface {v6, v7, v2, v5}, Lcom/android/internal/telephony/CommandsInterface;->deactivateDataCall(IILandroid/os/Message;)V
    ...
    .line 520
    :cond_5
    const-string v6, "tearDownData radio is off sendMessage EVENT_DEACTIVATE_DONE immediately"
