...
.method public getSignalLevel()I
    ...
    invoke-interface {v1}, Lcom/android/internal/telephony/ITelephony;->getSignalLevel()I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public isTddOnlyMode(Landroid/content/Context;)Z
    .locals 7
    .parameter "context"
    ...
    const-string v4, "isTddOnlyMode :: wpr mContext is null"
    ...
    const-string/jumbo v5, "nt_mode_tddonly"
    ...
    const-string v5, "lte_func_switch"
    ...
    const-string v6, "isTddOnlyMode :: wpr tddonly is "
    ...
    const-string v6, "isTddOnlyMode :: wpr ltemode is "
...
.method public setDomesticDataRoamingEnabled(Z)V
    .locals 4
    .parameter "status"
    ...
    invoke-interface {v1, p1}, Lcom/android/internal/telephony/ITelephony;->setDomesticDataRoamingEnabled(Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setDomesticVoiceRoaming(Z)V
    .locals 4
    .parameter "status"
    ...
    invoke-interface {v1, p1}, Lcom/android/internal/telephony/ITelephony;->setDomesticVoiceRoaming(Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setInternationalDataRoamingEnabled(Z)V
    .locals 4
    .parameter "status"
    ...
    invoke-interface {v1, p1}, Lcom/android/internal/telephony/ITelephony;->setInternationalDataRoamingEnabled(Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setInternationalVoiceRoaming(Z)V
    .locals 4
    .parameter "status"
    ...
    invoke-interface {v1, p1}, Lcom/android/internal/telephony/ITelephony;->setInternationalVoiceRoaming(Z)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setNetworkMode(I)V
    ...
    invoke-interface {v1, p1}, Lcom/android/internal/telephony/ITelephony;->setNetworkMode(I)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
