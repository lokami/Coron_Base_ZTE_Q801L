...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Landroid/net/wifi/WifiMonitor$MonitorApThread;
    }
.end annotation
...
.field private static final ASSOC_STR:Ljava/lang/String; = "ASSOC"
...
.field private static final DISASSOC_STR:Ljava/lang/String; = "DISASSOC"
...
# instance fields
.field private mApThread:Landroid/net/wifi/WifiMonitor$MonitorApThread;
...
.method public constructor <init>(Lcom/android/internal/util/StateMachine;Landroid/net/wifi/WifiNative;)V
    ...
    iput-object v0, p0, Landroid/net/wifi/WifiMonitor;->mApThread:Landroid/net/wifi/WifiMonitor$MonitorApThread;
...
.method static synthetic access$000(Landroid/net/wifi/WifiMonitor;)Landroid/net/wifi/WifiNative;
    ...
    .prologue
    .line 45
    iget-object v0, p0, Landroid/net/wifi/WifiMonitor;->mWifiApNative:Landroid/net/wifi/WifiNative;
...
.method public startMonitoringForAP(Landroid/net/wifi/WifiNative;)V
    .locals 2
    .parameter "wifiApNative"

    .prologue
    .line 383
    new-instance v0, Landroid/net/wifi/WifiMonitor$MonitorApThread;

    invoke-direct {v0, p0}, Landroid/net/wifi/WifiMonitor$MonitorApThread;-><init>(Landroid/net/wifi/WifiMonitor;)V
    ...
    const-string v1, " wangzhaoxin startMonitoringForAP!"

    invoke-static {v0, v1}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 385
    iput-object p1, p0, Landroid/net/wifi/WifiMonitor;->mWifiApNative:Landroid/net/wifi/WifiNative;

    .line 387
    iget-object v0, p0, Landroid/net/wifi/WifiMonitor;->mApThread:Landroid/net/wifi/WifiMonitor$MonitorApThread;
...
.method public stopMonitoringForAP()V
    .locals 2
    ...
    const-string v1, " wangzhaoxin stopMonitoringForAP 1111!"
    ...
    const-string v1, " wangzhaoxin stopMonitoringForAP 222222!"
    ...
    invoke-virtual {v0}, Landroid/net/wifi/WifiMonitor$MonitorApThread;->StopRetry()V
