...
.method private static getGeoDescription(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 578
    :cond_2
    const-string/jumbo v7, "persist.env.phone.location"
...
.method markAsEmergency(Landroid/content/Context;Ljava/lang/String;)Lcom/android/internal/telephony/CallerInfo;
    ...
    .line 400
    sget-boolean v0, Landroid/util/Config;->ZTE_FEATURE_YELLOW_PAGE:Z
    ...
    .line 403
    :cond_0
    invoke-virtual {p0, p1}, Lcom/android/internal/telephony/CallerInfo;->queryLocationEnabled(Landroid/content/Context;)Z
    ...
    const-string v1, "Yp is not enabled!"
    ...
    .line 411
    iput v3, p0, Lcom/android/internal/telephony/CallerInfo;->photoResource:I
...
.method public queryLocationEnabled(Landroid/content/Context;)Z
    .locals 11
    .parameter "context"
    ...
    const-string v3, "--djb---cursor == null"
    ...
    .line 667
    .local v8, enabled:Ljava/lang/String;
    sget-boolean v1, Lcom/android/internal/telephony/CallerInfo;->VDBG:Z
    ...
    .line 678
    .end local v8           #enabled:Ljava/lang/String;
    :cond_8
    if-eqz v6, :cond_9
